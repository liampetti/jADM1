...
public class BSM2Defaults {
	...
	public double[] DigesterInit() {
		...
		gas_ch4 = 0.0; // 37. 		(38) methane volume (m3/d)
		...
		// Bio P Reactions ----->
		S_IP = 0.0; // 44. 			(45) Inorganic phosphorus (ADM1) (kmole P/m3)
		X_PHA = 0.0; // 45. 		(46) Polyhydroxyalkanoates (kg COD/m3)[g COD/L]
		X_PP = 0.0; // 46. 			(47) Polyphosphates (kg COD/m3)[g COD/L]
		X_PAO = 0.0; // 47. 		(48) Phosphorus accumulating organisms (kg COD/m3)[g COD/L]
		// <---- Bio P Reactions
		temp1 = 0.0; // 48. 		(49) Optional
		temp2 = 0.0; // 49. 		(50) Optional
		temp3 = 0.0; // 50. 		(51) Optional
